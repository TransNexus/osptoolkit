...
typedef struct {
    ...
    float RFactor[OSPC_SDIR_NUMBER];
    float MOSCQ[OSPC_SDIR_NUMBER];
    float MOSLQ[OSPC_SDIR_NUMBER];
...
extern "C" {
    ...
    void OSPPStatsSetFloat(OSPT_STATS *, OSPE_STATS, OSPE_STATS_DIR, float);
    ...
    float OSPPStatsGetFloat(OSPT_STATS *, OSPE_STATS, OSPE_STATS_DIR);
