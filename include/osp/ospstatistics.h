...
typedef struct {
    ...
    OSPT_STATS_PACKET ospmLost[OSPC_SMETRIC_NUMBER][OSPC_SDIR_NUMBER];
    OSPT_STATS_METRICS ospmJitter[OSPC_SMETRIC_NUMBER][OSPC_SDIR_NUMBER];
    OSPT_STATS_METRICS ospmDelay[OSPC_SMETRIC_NUMBER][OSPC_SDIR_NUMBER];
    int ospmOctets[OSPC_SMETRIC_NUMBER][OSPC_SDIR_NUMBER];
    int ospmPackets[OSPC_SMETRIC_NUMBER][OSPC_SDIR_NUMBER];
    float ospmRFactor[OSPC_SMETRIC_NUMBER][OSPC_SDIR_NUMBER];
    float ospmMOSCQ[OSPC_SMETRIC_NUMBER][OSPC_SDIR_NUMBER];
    float ospmMOSLQ[OSPC_SMETRIC_NUMBER][OSPC_SDIR_NUMBER];
    int ospmICPIF[OSPC_SDIR_NUMBER];
} OSPT_STATS;
