...
extern "C" {
    ...
    OSPTBOOL OSPPUsageIndHasCodec(OSPT_USAGE_IND *, OSPE_CODEC_TYPE);
    const char *OSPPUsageIndGetCodec(OSPT_USAGE_IND *, OSPE_CODEC_TYPE);
    void OSPPUsageIndSetCodec(OSPT_USAGE_IND *, OSPE_CODEC_TYPE, const char *);
