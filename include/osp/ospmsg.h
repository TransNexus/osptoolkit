...
typedef enum {
    OSPC_RINFO_UNKNOWN = OSPC_MPART_UNKNOWN,     /* Not a known role info */
    OSPC_RINFO_UNDEFINED,
    /* Role type start */
    OSPC_RINFO_START = 0,
    /* Acme RADIUS */
    OSPC_RINFO_ACMERADSTART = OSPC_RINFO_START,
    OSPC_RINFO_ACMERADSTOP,
    OSPC_RINFO_ACMERADINTERIM,
    /* Acme local CDR */
    OSPC_RINFO_ACMECDRSTART,
    OSPC_RINFO_ACMECDRSTOP,
    OSPC_RINFO_ACMECDRINTERIM,
    OSPC_RINFO_ACMECDRINTERIMFAILED,
    /* GENBAND S3 RADIUS */
    OSPC_RINFO_GENBANDS3RADSTART1,
    OSPC_RINFO_GENBANDS3RADSTART2,
    OSPC_RINFO_GENBANDS3RADSTOP1,
    OSPC_RINFO_GENBANDS3RADSTOP2,
    OSPC_RINFO_GENBANDS3RADINTERIM1,
    OSPC_RINFO_GENBANDS3RADINTERIM2,
    /* GENBAND S3 local CDR */
    OSPC_RINFO_GENBANDS3CDRSTART1,
    OSPC_RINFO_GENBANDS3CDRSTART2,
    OSPC_RINFO_GENBANDS3CDREND1,
    OSPC_RINFO_GENBANDS3CDREND2,
    OSPC_RINFO_GENBANDS3CDRHUNT1,
    OSPC_RINFO_GENBANDS3CDRHUNT2,
    OSPC_RINFO_GENBANDS3CDRINTERIM,
    /* Number of role info */
    OSPC_RINFO_NUMBER
} OSPE_ROLE_INFO;
...
extern const OSPT_MSG_DESC OSPV_RINFO_DESCS[];
...
extern "C" {
    ...
    OSPE_ROLE_INFO OSPPRoleInfoGetPart(const char *);
    const char *OSPPRoleInfoGetName(OSPE_ROLE_INFO);
