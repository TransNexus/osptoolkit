...
typedef enum {
    ...
    OSPC_MELEM_CONTACT,
    OSPC_MELEM_CPSLATENCY,
    OSPC_MELEM_CPSRSPCODE,
    ...
    OSPC_MELEM_JIP,
    OSPC_MELEM_JITTER,
    OSPC_MELEM_JURISDICTIONTYPE,
    OSPC_MELEM_LASTREDIRECTBEHALF,
    OSPC_MELEM_LASTREDIRECTREASON,
    OSPC_MELEM_LATENCY,
    OSPC_MELEM_LOSSRCVD,
    OSPC_MELEM_LOSSSENT,
    OSPC_MELEM_LOST,
    ...
    OSPC_MELEM_OOB,
    OSPC_MELEM_ORIGID,
    OSPC_MELEM_ORIGREDIRECTBEHALF,
    OSPC_MELEM_ORIGREDIRECTREASON,
    OSPC_MELEM_PACKETS,
