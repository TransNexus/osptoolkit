...
/* The following data is only used in ospasn1id.c where the #define is
    defined */
...
/* AlgorithmId encoded values contain only the oid and attribute types and
values. The sequence prefix is not included in the definition */
...
{  
    ...
    OSPM_IDIDX(OSPEID_EXTENDEDCERTIFICATEATTRIBUTES, 
                ospgExtendedCertificateAttributes),
    ...
    OSPM_IDIDX(OSPEID_PHYSICALDELIVERYOFFICENAME, 
                ospgPhysicalDeliveryOfficeName),
    ...
    OSPM_IDIDX(OSPEID_SUPPORTEDAPPLICATIONCONTEXT,
                ospgSupportedApplicationContext),
    ...
    OSPM_IDIDX(OSPEID_CERTIFICATEREVOCATIONLIST,
                ospgCertificateRevocationList),
...
extern "C"
{
    ...
    */
    ...
    OSPPASN1IdGetValue(
        ...
        unsigned char   **ospvObjectIdValue,
        unsigned        *ospvObjectIdLength);
