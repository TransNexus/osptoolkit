...
)
{
    ...
    /* This is the communications manager that will handle all of the 
     * requests to the enrollment server:
     */
    ...
    if ( ( ospvEnrollParamsIn == OSPC_OSNULL ) || 
         ( ospvLocalCertOut == OSPC_OSNULL ) ||
         ( ospvLocalCertLenOut == OSPC_OSNULL ) ||
         ( ospvEnrollStatusOut == OSPC_OSNULL ) ) 
    {
        retVal = OSPC_ERR_ENROLL_INVALID_ARG;
        OSPM_DBGERRORLOG (
             retVal,
             "The parameters passed in for enrollment were invalid. )\n" );
    }
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        ...
        if ( retVal != OSPC_ERR_NO_ERROR )
        {
            OSPM_DBGERRORLOG (
                 retVal,
                 "Unable to base64-decode the CA certificate passed in.\n" );
        }
    }
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        ...
        if ( retVal != OSPC_ERR_NO_ERROR )
        {
            OSPM_DBGERRORLOG (
                 retVal,
                 "Unable to initialize MessageInfo for enrollment request.\n" );
        }
    }
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        ...
        retVal = 
            OSPPGetPublicKeyInfoFromCertReq( 
        ...
        if ( retVal != OSPC_ERR_NO_ERROR )
        {
            OSPM_DBGERRORLOG (
                 retVal,
                 "Cannot find public key info in PKCS#10 cert request.\n" );
        }
    }
    ...
    {
        retVal = 
            OSPPConstructEnrollmentRequest( 
                ospvEnrollParamsIn, 
                enrollMsg );
        ...
        if ( retVal != OSPC_ERR_NO_ERROR )
        {
            OSPM_DBGERRORLOG( 
                retVal, 
                "Unable to construct enrollment request for transmission.\n" );
        }
    }

    /* If ( we could initialize the MsgInfo's Request ) then
     *  o Initialize the comm mgr.
     */
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        retVal = 
            OSPPInitSecureCommMgr( 
                 ospvEnrollParamsIn, 
                 ospvCommParamsIn, 
                 &commMgr );
        ...
        if ( retVal != OSPC_ERR_NO_ERROR )
        {
            OSPM_DBGERRORLOG( 
                retVal, 
                "Unable to initialize secure enrollment communications.\n" );
        }
    }

    /* If ( there's a comm mgr that works ) then
     *  o try enrolling the device.
     */
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        retVal = 
        ...
        {
            OSPM_DBGMISC(( 
                "Message successfully received from enrollment server.\n" )); 
        ...
        else
        {
            OSPM_DBGERRORLOG( 
                retVal, 
                "Unable to retrieve certificate from enrollment server.\n" );
        }
    }
    ...
    if ( commMgr != OSPC_OSNULL )
    {
        ...
        {
            OSPM_DBGMISC(( 
                "Warning: error while cleaning up comm manager: <%d>\n", 
                warnVal ));
        }
    }
...
)
{
         ...
         ( ospvEnrollParamsIn->CACertB64Len <= 0 ) )
    {
        ...
        OSPM_DBGERRORLOG( 
            retVal,
             "Invalid arguments passed in for decoding the CA certificate.\n" );
    }
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        ...
        if ( caCert == OSPC_OSNULL )
        {
            ...
            OSPM_DBGERRORLOG( 
                retVal,
                 "Unable to allocate memory for the CA cert.\n" );
        }
    }
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        ...
        retVal = 
            OSPPBase64Decode( 
                (const char *)ospvEnrollParamsIn->CACertB64,
                ospvEnrollParamsIn->CACertB64Len, 
                caCert, 
                &caCertLen );
        if ( retVal != OSPC_ERR_NO_ERROR )
        {
            OSPM_DBGERRORLOG( 
                retVal,
                 "Unable to base64-decode CA cert.\n" );
        }
    }
...
)
{
     ...
     */
    if ( ( ospvCommMgrIn == OSPC_OSNULL ) ||
         ( ospvEnrollMsgIn == OSPC_OSNULL ) ||
         ( ospvEnrollStatusOut == OSPC_OSNULL ) ||
         ( ospvCertOut == OSPC_OSNULL ) ||
         ( ospvCertLenOut == OSPC_OSNULL ) )
    {
        retVal = OSPC_ERR_ENROLL_INVALID_ARG;
        OSPM_DBGERRORLOG( 
            retVal,
             "The parameters for enrolling a device are invalid.\n" );
    }
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        ...
        if ( retVal != OSPC_ERR_NO_ERROR )
        {
            OSPM_DBGERRORLOG( 
                retVal,
                 "Unable to add the enrollment request to the communications manager.\n" );
        }
    }
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        ...
        if ( retVal != OSPC_ERR_NO_ERROR )
        {
            OSPM_DBGERRORLOG( 
                retVal,
                 "Unable to transmit request to the enrollment server.\n" );
        }
    }
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        ...
        if ( enrollResponse == OSPC_OSNULL )
        {
            ...
            OSPM_DBGERRORLOG(
                retVal,
                "Unable to allocate memory for null-terminated response.\n" );
        }
    }
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        ...
        if ( retVal != OSPC_ERR_NO_ERROR )
        {
            OSPM_DBGERRORLOG( 
                retVal,
                 "Unable to find the cert request status in the response.\n" );
        }
    }
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        ...
        else
        {
            OSPM_DBGERRORLOG( 
                retVal,
                 "Invalid status returned - assuming cert request failed.\n" );
        }
    }
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        ...
        *ospvEnrollStatusOut = status;
        ...
        if ( status == OSPC_ENROLL_STATUS_OK )
        {
            ...
            if ( retVal == OSPC_ERR_NO_ERROR )
            {
                ...
                if ( retVal != OSPC_ERR_NO_ERROR ) 
                {
                    ...
                    OSPM_DBGERRORLOG( 
                        retVal,
                         "Unable to extract certificate from response indicating success.\n" );
                }
            }
        ...
        {
            OSPM_DBGMISC(( 
                "Warning: Failure code received from server: %d\n", 
                *ospvEnrollStatusOut ));
        }
...
)
{
    ...
    /* This is the temporary variable for holding the 
     * outgoing subjectPublicKeyInfo:
     */
     ...
     */
    if ( ( ospvCertB64In == OSPC_OSNULL ) || 
         ( ospvCertOut  == OSPC_OSNULL ) ||
         ( ospvCertLenOut == OSPC_OSNULL ) )
    {
        retVal = OSPC_ERR_ENROLL_INVALID_ARG;
        OSPM_DBGERRORLOG( 
            retVal, "Invalid parameters for validating a device cert.\n" );
    }
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        ...
        retVal = 
            OSPPBase64Decode( 
                (const char *)ospvCertB64In, 
                certb64BufLen, 
                *ospvCertOut, 
                ospvCertLenOut );

        /* If ( there was a problem ) then
         *  o set the error code to indicate the certificate received was bogus.
         */ 
        if ( retVal != OSPC_ERR_NO_ERROR )
        {
            OSPM_DBGERRORLOG( 
                retVal,
                 "Unable to base64-decode certificate\n" );
        }
    }

    /* If ( everything's ok ) then 
     *   o Check the certificate's public key and CA certificate.
     */
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        ...
        if ( retVal != OSPC_ERR_NO_ERROR )
        {
            OSPM_DBGERRORLOG( 
                retVal,
                 "Invalid X.509 certificate returned.\n" );
        }
    }
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        ...
        if ( retVal != OSPC_ERR_NO_ERROR )
        {
            OSPM_DBGERRORLOG( 
                retVal, 
                "Unable to retrieve public key from certificate retrieved.\n" );
        }
    }
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        ...
        if ( retVal != OSPC_ERR_NO_ERROR )
        {
            OSPM_DBGERRORLOG( 
                retVal, 
                "Public Key in certificate does not match public key in request.\n" );
        }
    }
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        ...
        retVal = 
            OSPPX509CertValidateCertificate( 
                x509CertOut, 
                ospvSecIn->AuthorityCertInfo,
                ospvSecIn->NumberOfAuthorityCertificates,
                &caCertIndex );
        ...
        if ( retVal != OSPC_ERR_NO_ERROR )
        {
            OSPM_DBGERRORLOG( 
                retVal, 
                "The certificate returned was not signed by the given CA certificate.\n" );
        }
    }
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        ...
        OSPPDumpHex( 
            x509CertOut->ElementInfo->Element, 
...
)
{
    ...
    /* If ( either of the parameters are null ) then
     *  o set an error code and complain.
     */
    if ( ( ospvLHSObject == OSPC_OSNULL ) ||
         ( ospvRHSObject == OSPC_OSNULL ) ||
         ( ospvLHSObject->ElementInfo == OSPC_OSNULL ) ||
         ( ospvRHSObject->ElementInfo == OSPC_OSNULL ) ||
         ( ospvLHSObject->ElementInfo->Element == OSPC_OSNULL ) ||
        ...
        )
    {
        ...
        OSPM_DBGERRORLOG( 
            retVal, 
            "At least one of the ASN1 objects being compared is invalid.\n" );

        if ( ospvLHSObject == OSPC_OSNULL )
        {
            OSPM_DBGERRORLOG( 
                retVal,
                 "The first parameter to OSPPASN1Compare is null.\n" );
        }
        ...
        if ( ospvRHSObject == OSPC_OSNULL )
        {
            OSPM_DBGERRORLOG( 
                retVal,
                 "The second parameter to OSPPASN1Compare is null.\n" );
        }
        ...
        if ( ospvLHSObject->ElementInfo == OSPC_OSNULL )
        {
            OSPM_DBGERRORLOG( 
                retVal,
                 "The first parameter's element info  is null.\n" );
        }
        ...
        if ( ospvRHSObject->ElementInfo == OSPC_OSNULL )
        {
            OSPM_DBGERRORLOG( 
                retVal,
                 "The second parameter's element info  is null.\n" );
        }
        ...
        if ( ospvLHSObject->ElementInfo->Element == OSPC_OSNULL )
        {
            OSPM_DBGERRORLOG( 
                retVal,
                 "The first parameter's element info content  is null.\n" );
        }
        ...
        if ( ospvRHSObject->ElementInfo->Element == OSPC_OSNULL )
        {
            OSPM_DBGERRORLOG( 
                retVal,
                 "The second parameter's element info content  is null.\n" );
        }
    }
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        retVal = 
            OSPM_STRNCMP(
                (const char *)((ospvLHSObject->ElementInfo)->Element),
                (const char *)((ospvRHSObject->ElementInfo)->Element),
                (ospvLHSObject->ElementInfo)->ElementLength );
        if ( retVal != 0 )
        {
            ...
            OSPM_DBGERRORLOG( 
                retVal,
                 "The two ASN1 objects are of unequal value.\n" );
        }
    }
...
)
{
         ...
         ( ospvPublicKeyOut == OSPC_OSNULL ) )
    {
        ...
        if ( ospvCertIn == OSPC_OSNULL )
        {
            OSPM_DBGERRORLOG( 
                retVal,
                 "The certificate passed in is null.\n" );
        }
    ...
    if  ( retVal == OSPC_ERR_NO_ERROR )
    {
        ...
        if ( retVal != OSPC_ERR_NO_ERROR )
        {
            OSPM_DBGERRORLOG( 
                retVal,
                 "Unable to find subjectPublicKeyInfo in certificate\n" );
...
int OSPPGetPublicKeyInfoFromCertReq(
    unsigned char*   ospvCertReqB64In, 
    OSPTASN1OBJECT*  ospvPublicKeyOut 
) 
{
    int retVal = OSPC_ERR_NO_ERROR;
...
)
{
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        ...
        if ( retVal != OSPC_ERR_NO_ERROR )
        {
            OSPM_DBGERRORLOG( 
                retVal,
                 "Unable to create enrollment request's header.\n" );
        }
    }
    ...
    /* Else ( we ran into some problem ) so
     *  o free up the requestBfr if necessary
     */
    else
    {
...
)
{
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        ...
        if ( retVal != OSPC_ERR_NO_ERROR )
        {
            ...
            OSPM_DBGERRORLOG( 
                retVal,
                 "An invalid ( non-alnum ) username was entered.\n" );
        }
    }
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        ...
        if ( retVal != OSPC_ERR_NO_ERROR )
        {
            ...
            OSPM_DBGERRORLOG( 
                retVal,
                 "An invalid ( non-alnum ) password was entered.\n" );
        }
    }
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        ...
        if ( retVal != OSPC_ERR_NO_ERROR )
        {
            ...
            OSPM_DBGERRORLOG( 
                retVal,
                 "An invalid ( non-digit ) device id was entered.\n" );
        }
    }
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        ...
        if ( retVal != OSPC_ERR_NO_ERROR )
        {
            ...
            OSPM_DBGERRORLOG( 
                retVal,
                 "An invalid ( non-digit ) customer id was entered.\n" );
        }
    }
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        if ( ( ospvEnrollParams->CertReq == OSPC_OSNULL ) ||
             ( OSPM_STRLEN( (const char *)ospvEnrollParams->CertReq ) <= 0 ) ) 
        {
...
)
{
    ...
    if ( ( ospvNonceOut == OSPC_OSNULL ) ||  
         ( ospvNonceLenOut == OSPC_OSNULL ) ||
         ( ospvNonceLenIn <= 0 ) )
    {
        retVal = OSPC_ERR_ENROLL_INVALID_ARG;
        OSPM_DBGERRORLOG( 
            retVal,
             "Bad arguments for creating a nonce.\n" );
    }
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        ...
        if ( *ospvNonceOut == OSPC_OSNULL )
        {
            ...
            OSPM_DBGERRORLOG( 
                retVal,
                 "Unable to alloc memory for nonce.\n" );
        }
    }
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        ...
        retVal = 
            OSPPFillBufWithRandomBytes( 
                *ospvNonceOut, 
                ospvNonceLenOut, 
                ospvNonceLenIn ); 

        if ( ( retVal != OSPC_ERR_NO_ERROR ) || 
             ( *ospvNonceOut == OSPC_OSNULL ) || 
             ( *ospvNonceLenOut <= 0 ) )
        {
            retVal = OSPC_ERR_ENROLL_GEN_NONCE;
            OSPM_DBGERRORLOG( 
...
)
{
    ...
    if ( ospvRequestBfrOut == OSPC_OSNULL )
    {
        ...
        OSPM_DBGERRORLOG( 
            retVal,
             "The buffer for the enrollment request's body was null.\n" );
    }
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        if ( ospvEnrollParamsIn == OSPC_OSNULL ) 
        {
            ...
            OSPM_DBGERRORLOG( 
                retVal, 
                "The enrollment parameters for the enrollment request were null.\n" );
        }
    }
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        ...
        if ( retVal != OSPC_ERR_NO_ERROR )
        {
            OSPM_DBGERRORLOG( 
                retVal, 
                "The enrollment request parameters are invlaid.\n" );
        }
    }
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
             ...
             ( ospvEnrollParamsIn->NonceLen <= 0 ) )
        {
            ...
            OSPM_DBGERRORLOG( 
                retVal, 
                "The nonce for the enrollment request was null or empty.\n" );
        }
    }
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        ...
        if ( *ospvRequestBfrOut == OSPC_OSNULL )
        {
            ...
            OSPM_DBGERRORLOG( 
                retVal, 
                "Unable to allocate memory for the outbound request.\n" );
        }
    }
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        ...
        {    
            ...
            OSPM_DBGERRORLOG( 
                retVal,
                 "Unable to append operation to request body.\n" );
        }
    }
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        ...
        {    
            ...
            OSPM_DBGERRORLOG( 
                retVal,
                 "Unable to append nonce to request body.\n" );
        }
    }
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        ...
        {    
            ...
            OSPM_DBGERRORLOG( 
                retVal,
                 "Unable to append username to request body.\n" );
        }
    }
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        ...
        {    
            ...
            OSPM_DBGERRORLOG( 
                retVal,
                 "Unable to append password to request body.\n" );
        }
    }
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        ...
        {    
            ...
            OSPM_DBGERRORLOG( 
                retVal,
                 "Unable to append device id to request body.\n" );
        }
    }
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        ...
        {    
            ...
            OSPM_DBGERRORLOG( 
                retVal,
                 "Unable to append customer id to request body.\n" );
        }
    }
...
int OSPPCreateEnrollmentRequestHeader(
    OSPTMSGINFO* ospvEnrollReqMsgInfo
)
{
    int retVal = OSPC_ERR_NO_ERROR;
    ...
    {
        OSPM_MALLOC( 
            ospvEnrollReqMsgInfo->ContentType, 
            unsigned char, 
            OSPM_STRLEN( OSPC_ENROLL_CONTENT_TYPE ) + 1 );
        ...
        if ( ospvEnrollReqMsgInfo->ContentType == OSPC_OSNULL )
        {
            ...
            OSPM_DBGERRORLOG( 
                retVal,
                 "Unable to allocate memory for content type.\n" );
        }
    }
    ...
    {
        OSPM_STRCPY( 
            (char *)ospvEnrollReqMsgInfo->ContentType, 
            OSPC_ENROLL_CONTENT_TYPE ); 
    }
...
int OSPPFillBufWithRandomBytes( 
    unsigned char*  ospvRandomByteBuf,
...
)
{
    ...
    /* How many bytes should be copied? We may need less if we're going to
     * potentially overflow ospvRandomByteBuf.
     */
    int bytesToCopy          = 0;

    /* How many more bytes are needed for the buffer?  Equal to 
     * bytesToBeFilled - bytesFilled
     */
    ...
    /* If ( the parameters are invalid ) then
     *  o set an error code and complain. 
     */
    if ( ( ospvRandomByteBuf == OSPC_OSNULL ) || 
         ( ospvBytesCreated == OSPC_OSNULL ) || 
         ( ospvBytesRequest <= 0 ) )
    {
        retVal = OSPC_ERR_ENROLL_INVALID_ARG;
        OSPM_DBGERRORLOG( 
            retVal, 
            "Invalid arguments for generating random bytes.\n" );
    }
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        ...
        if ( tempRandomBytes == OSPC_OSNULL )
        {
            ...
            OSPM_DBGERRORLOG( 
                retVal, 
                "Unable to allocate memory for random bytes.\n" );
        }
    }
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        ...
        while ( bytesRemainingToFill > 0 ) 
        {
            ...
            OSPM_STRNCPY( 
                ospvRandomByteBuf + bytesFilled, 
                tempRandomBytes, 
                bytesToCopy );

            seed += bytesFilled + bytesToCopy 
                  + ospvRandomByteBuf[ bytesFilled ];
    ...
    /* Now finish the operation by assigning the bytes created to the 
     * output buffer:
     */
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
    ...
    /* Free up the temporary memory we created; the same bytes should
     * be ospvRandomByteBuf:
     */
    if ( tempRandomBytes != OSPC_OSNULL )
    {
...
)
{
    ...
    /* If ( the destination string or name to be appended are null ) then
     *  o set an error code and complain.
     */
    if ( ( ospvDestStr == OSPC_OSNULL ) || 
         ( ospvName == OSPC_OSNULL ) ||
         ( ospvValue == OSPC_OSNULL ) )
    {
        retVal = OSPC_ERR_ENROLL_INVALID_ARG;
        OSPM_DBGERRORLOG( 
            retVal, 
            "The parameters for appending a name-value pair are invalid.\n" );
    }
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        ...
        if ( retVal != OSPC_ERR_NO_ERROR )
        {
            OSPM_DBGERRORLOG( 
                retVal,
                "Unable to append the url-encoded name in the name-value pair.\n" );
        }
    }
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        ...
        if ( retVal != OSPC_ERR_NO_ERROR )
        {
            OSPM_DBGERRORLOG( 
                retVal,
                "Unable to append the url-encoded value in the name-value pair.\n" );
        }
    }
...
)
{
    ...
    if ( ( destStr == OSPC_OSNULL ) &&
         ( srcStr == OSPC_OSNULL ) )
    {
        retVal = OSPC_ERR_ENROLL_INVALID_ARG;
        OSPM_DBGERRORLOG( 
            retVal,
             "The source or destination string is null.\n" );
    }
...
)
{
    ...
    if ( ospvAsciiStr == OSPC_OSNULL )
    {
        ...
        OSPM_DBGERRORLOG( 
            retVal,
             "Invalid parameter for checking an ascii string\n" );
    }
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        ...
        if ( asciiStrLen <= 0 )
        {
            ...
            OSPM_DBGERRORLOG( 
                retVal,
                 "The ascii string passed in was empty" );
        }
    }
    ...
    {
        for ( strIndex = 0; 
              ( strIndex < asciiStrLen ) && ( retVal == OSPC_ERR_NO_ERROR );
              strIndex++ )
        {
...
) 
{
    ...
    if ( ospvDigitStr == OSPC_OSNULL )
    {
        ...
        OSPM_DBGERRORLOG( 
            retVal,
             "The string to be checked was null.\n" );
    }
    ...
    if ( retVal == OSPC_ERR_NO_ERROR )
    {
        ...
        if ( digitStrLen <= 0 )
        {
            ...
            OSPM_DBGERRORLOG( 
                retVal,
                 "The string to be checked was empty.\n" );
        }
    }
...
)
{
    ...
    if ( ( ospvCommMgrIn == OSPC_OSNULL ) ||
         ( *ospvCommMgrIn == OSPC_OSNULL ) )
    {
        retVal = OSPC_ERR_ENROLL_INVALID_ARG;
        OSPM_DBGMISC(( 
            "Warning: The comm manager to be cleaned up is invalid.\n" ));
    }
