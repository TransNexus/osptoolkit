...
# ADD CPP /nologo /W3 /GX /O2 /I "..\include" /I "..\crypto" /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D "_MBCS" /YX /FD /c
...
# ADD LINK32 kernel32.lib libcmt.lib user32.lib wsock32.lib osp.lib ssleay32.lib libeay32.lib /nologo /subsystem:console /machine:I386 /nodefaultlib /out:"../bin/enroll.exe" /libpath:"..\lib"
...
# ADD CPP /nologo /W3 /Gm /GX /ZI /Od /I "..\include" /I "..\crypto" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /D "BSAFE" /D "WIN32" /YX /FD /D /| /GZ /c
...
# ADD LINK32 kernel32.lib libcmt.lib user32.lib wsock32.lib osp.lib ssleay32.lib libeay32.lib /nologo /subsystem:console /debug /machine:I386 /nodefaultlib /out:"../bin/enroll.exe" /pdbtype:sept /libpath:"..\lib"
# SUBTRACT LINK32 /pdb:none
